...
#
#Use Seaborn's .lmplot() and show best-fit lines across multiple categories using the row, 
# hue, and lowess parameters.
#
#Understand how a different picture emerges when looking at the same data in different ways 
# (e.g., box plots vs a time series analysis).
#
#See the distribution of our data and visualise descriptive statistics with the help of a
